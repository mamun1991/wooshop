          ...
          <section class="py-16 bg-white dark:bg-slate-900/50" data-scroll-animate>
            <div class="max-w-[1440px] mx-auto px-6 md:px-20">
              ...
              <div class="flex overflow-x-auto pb-8 gap-6 no-scrollbar snap-x">
                <!-- Product 1 -->
                <div class="product-card min-w-[280px] md:min-w-[320px] snap-start group" data-product-id="1" data-product-name="Eco-Hydrate Bottle" data-product-price="35.00" data-product-image="https://lh3.googleusercontent.com/aida-public/AB6AXuCSq9hUycFqB6ZU7zKH6JfNJZTgEiRb77T1xWuKEfpzRUBpvHlErRU6_J8-XITHlrGv4YzSfxQo5fCiIDft6gwHGc2KxGZDJwKxUO9vHGoKwUnjyE6x_HL5Lus5DFfGY3SgXG8N0iF_z8Mn1mmr2afd-sKJTt95f0E1vppI3OdVoS975CyZxRPKgU5Qe6OoIRCTtvBd1ihrFS3iMTk_di9_f_hxW_q7sFCSYZ7dN7JU7QdlV48tjTLBthOEudr0BmjPQUnWpje1Ww4">
                  <div class="relative aspect-[3/4] rounded-2xl overflow-hidden mb-4 bg-slate-100 dark:bg-slate-800">
                    <div class="w-full h-full bg-center bg-cover transition-transform duration-500 group-hover:scale-110" data-alt="Eco-friendly insulated hydration bottle in matte blue" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuCSq9hUycFqB6ZU7zKH6JfNJZTgEiRb77T1xWuKEfpzRUBpvHlErRU6_J8-XITHlrGv4YzSfxQo5fCiIDft6gwHGc2KxGZDJwKxUO9vHGoKwUnjyE6x_HL5Lus5DFfGY3SgXG8N0iF_z8Mn1mmr2afd-sKJTt95f0E1vppI3OdVoS975CyZxRPKgU5Qe6OoIRCTtvBd1ihrFS3iMTk_di9_f_hxW_q7sFCSYZ7dN7JU7QdlV48tjTLBthOEudr0BmjPQUnWpje1Ww4")'></div>
                  ...
                  <h3 class="font-bold text-lg text-slate-900 dark:text-slate-100">Eco-Hydrate Bottle</h3>
                  <p class="text-primary font-bold">$35.00</p>
                </div>
                <!-- Product 2 -->
                <div class="product-card min-w-[280px] md:min-w-[320px] snap-start group" data-product-id="2" data-product-name="Urban Carry-All" data-product-price="65.00" data-product-image="https://lh3.googleusercontent.com/aida-public/AB6AXuDTto13eooUrREk-Oz0asuaXwR5TE_u9_HOfsbO3jP9kE_errhOj8aqvl29tNR5kPSWmfVVkRw_j0Y920u_JPaU6RWLb1p8KKOSDyHX_o7n1RFFN4lfocjoxkCDglRf5Q4BUqq_SJJjV66y_2YKwq5noFXwFjHiADcQKuS943OzxCSLtPzovnSAh0LUUft6tQRL6sMXvLTsikBjVW1YDTTD2H7l2vjwsO0LR_2sFdyxtr3rA6ZAHdhxO0-YKkRDao44EAikZ8TuJps">
                  <div class="relative aspect-[3/4] rounded-2xl overflow-hidden mb-4 bg-slate-100 dark:bg-slate-800">
                    <div class="w-full h-full bg-center bg-cover transition-transform duration-500 group-hover:scale-110" data-alt="Minimalist urban backpack in charcoal grey" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuDTto13eooUrREk-Oz0asuaXwR5TE_u9_HOfsbO3jP9kE_errhOj8aqvl29tNR5kPSWmfVVkRw_j0Y920u_JPaU6RWLb1p8KKOSDyHX_o7n1RFFN4lfocjoxkCDglRf5Q4BUqq_SJJjV66y_2YKwq5noFXwFjHiADcQKuS943OzxCSLtPzovnSAh0LUUft6tQRL6sMXvLTsikBjVW1YDTTD2H7l2vjwsO0LR_2sFdyxtr3rA6ZAHdhxO0-YKkRDao44EAikZ8TuJps")'></div>
                    <button class="add-to-cart-btn absolute bottom-4 right-4 h-12 w-12 bg-white rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0 duration-300 hover:scale-110 hover:bg-primary hover:text-white cursor-pointer" title="Click to add to cart" @click="addToCart($event)">
                      <span class="material-symbols-outlined">add_shopping_cart</span>
                    </button>
                  </div>
                  <h3 class="font-bold text-lg text-slate-900 dark:text-slate-100">Urban Carry-All</h3>
                  <p class="text-primary font-bold">$65.00</p>
                </div>
                <!-- Product 3 -->
                <div class="product-card min-w-[280px] md:min-w-[320px] snap-start group" data-product-id="3" data-product-name="Studio Task Light" data-product-price="120.00" data-product-image="https://lh3.googleusercontent.com/aida-public/AB6AXuAer_sQJBn6J62pHQ3IVWbfjkfbfJ57CW3yfrvKstEcBJsWUMDktLg83T6Y6Af0SClV7SrcJNM90s2EWozSMz-XjpOXXG4PLurpB8NWzCm3ma-bjGgH37ueesamC0pFF8_o_Dl_jAxqChFhOLjYAKHb3hYnyF6Kg_QxuNuwxfNC3Dpg_faIaZhcXd1PR0EJnBhG2KVMQqDXyt0MOibhdK8bTODJN9gdAaM7LCjl8cAyeMTRrbr09BWTp4blt1P8JyIqEpF4YhWILQ4">
                  <div class="relative aspect-[3/4] rounded-2xl overflow-hidden mb-4 bg-slate-100 dark:bg-slate-800">
                    <div class="w-full h-full bg-center bg-cover transition-transform duration-500 group-hover:scale-110" data-alt="Modern studio desk lamp with adjustable arm" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuAer_sQJBn6J62pHQ3IVWbfjkfbfJ57CW3yfrvKstEcBJsWUMDktLg83T6Y6Af0SClV7SrcJNM90s2EWozSMz-XjpOXXG4PLurpB8NWzCm3ma-bjGgH37ueesamC0pFF8_o_Dl_jAxqChFhOLjYAKHb3hYnyF6Kg_QxuNuwxfNC3Dpg_faIaZhcXd1PR0EJnBhG2KVMQqDXyt0MOibhdK8bTODJN9gdAaM7LCjl8cAyeMTRrbr09BWTp4blt1P8JyIqEpF4YhWILQ4")'></div>
                    <button class="add-to-cart-btn absolute bottom-4 right-4 h-12 w-12 bg-white rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0 duration-300 hover:scale-110 hover:bg-primary hover:text-white cursor-pointer" title="Click to add to cart" @click="addToCart($event)">
                      <span class="material-symbols-outlined">add_shopping_cart</span>
                    </button>
                  </div>
                  <h3 class="font-bold text-lg text-slate-900 dark:text-slate-100">Studio Task Light</h3>
                  <p class="text-primary font-bold">$120.00</p>
                </div>
                <!-- Product 4 -->
                <div class="product-card min-w-[280px] md:min-w-[320px] snap-start group" data-product-id="4" data-product-name="Midnight Bloom Candle" data-product-price="28.00" data-product-image="https://lh3.googleusercontent.com/aida-public/AB6AXuCkplv3hxNqyrrlNirdvMWoKV5d0TMk1bcHMjvTkzvcqyqQ02EiHt8FO-j9jvqhJqImpq4jjVRjpnwVFfjbwBMy31vl-xuc3mVojCymeddaVygvCTY00-Gxckd6Qxip-PyKyXOGrSoUG7egLpJAWJmZK84wWkxQ702dh4MUlHoc-1wM0PR0omQL5BsTEiwy74NYkJlA8Dn7y86USXex3BFfe1qCqRavJZNRDFpC7NY-GG6zWO3nrsD-4Pn5OAIfJviSkriCRDU4JX4">
                  <div class="relative aspect-[3/4] rounded-2xl overflow-hidden mb-4 bg-slate-100 dark:bg-slate-800">
                    <div class="w-full h-full bg-center bg-cover transition-transform duration-500 group-hover:scale-110" data-alt="Luxury scented candle in a dark glass jar" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuCkplv3hxNqyrrlNirdvMWoKV5d0TMk1bcHMjvTkzvcqyqQ02EiHt8FO-j9jvqhJqImpq4jjVRjpnwVFfjbwBMy31vl-xuc3mVojCymeddaVygvCTY00-Gxckd6Qxip-PyKyXOGrSoUG7egLpJAWJmZK84wWkxQ702dh4MUlHoc-1wM0PR0omQL5BsTEiwy74NYkJlA8Dn7y86USXex3BFfe1qCqRavJZNRDFpC7NY-GG6zWO3nrsD-4Pn5OAIfJviSkriCRDU4JX4")'></div>
                    <button class="add-to-cart-btn absolute bottom-4 right-4 h-12 w-12 bg-white rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0 duration-300 hover:scale-110 hover:bg-primary hover:text-white cursor-pointer" title="Click to add to cart" @click="addToCart($event)">
                      <span class="material-symbols-outlined">add_shopping_cart</span>
                    </button>
                  </div>
                  <h3 class="font-bold text-lg text-slate-900 dark:text-slate-100">Midnight Bloom Candle</h3>
                  <p class="text-primary font-bold">$28.00</p>
                </div>
              </div>
            </div>
          </section>
